...
class L1Penalty(object):
    ...
    def __call__(self, parameter):
        ...
        L1_penalty = self.coefficient * np.sum(np.absolute(parameter))
        return L1_penalty
...
class L2Penalty(object):
    ...
    def __call__(self, parameter):
        ...
        Returns:
            Value of penalty term.
        """
        print(np.sum(np.square(parameter)))
        L2_penalty = self.coefficient * np.sum(np.square(parameter))
        return (1/2)*L2_penalty
